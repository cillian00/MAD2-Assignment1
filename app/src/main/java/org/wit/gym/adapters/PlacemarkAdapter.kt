...
import org.wit.placemark.databinding.CardGymBinding

interface PlacemarkListener {
    fun onPlacemarkClick(placemark: GymModel)
}

class PlacemarkAdapter constructor(private var placemarks: List<GymModel>,
