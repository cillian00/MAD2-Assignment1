...
import org.wit.gym.showImagePicker
import org.wit.placemark.R
import org.wit.placemark.databinding.ActivityGymBinding
...
class GymActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAdd.setOnClickListener() {
            ...
            // Directly using the value from the NumberPicker, assuming you want to store it as an Int
            // If `members` is supposed to be a String in your GymModel, you should convert it: gym.members = binding.members.value.toString()
            gym.members = binding.members.value

            // Assuming `activity` is an EditText
